...
use crate::entities::{Entity, Kind};
...
pub trait Graph {
    ...
    /// not just ones actually in the graph.
    fn contains<E: Entity>(&self, entity: E) -> bool;
}

/// A trait to provide access to an entity's stored data.
...
pub trait Map {
    ...
    ///
    /// This method must be flexible and able to do the check for any Entity type,
    /// not just ones actually in the map.
    fn contains<E: Entity>(&self, entity: E) -> bool;
}
...
//                Atom::old_get_slotmap(self.core()).contains_key(atom.to_key())
//            }
//            ResolvedEntity::Bond(bond) => {
//                Bond::old_get_slotmap(self.core()).contains_key(bond.to_key())
//            }
//            ResolvedEntity::Pseudoatom(pseudoatom) => {
//                Pseudoatom::old_get_slotmap(self.core()).contains_key(pseudoatom.to_key())
//            }
//            ResolvedEntity::Substituent(substituent) => {
//                Substituent::old_get_slotmap(self.core()).contains_key(substituent.to_key())
//            }
//            ResolvedEntity::Molecule(molecule) => {
//                Molecule::old_get_slotmap(self.core()).contains_key(molecule.to_key())
//            }
//        }
//    }
//
